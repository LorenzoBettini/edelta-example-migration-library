...
Measuring impact of model size (constant number of files = 4)...
  factor=1, totalElements=8 -> 5.30 ms
  factor=2, totalElements=16 -> 3.74 ms
  factor=4, totalElements=32 -> 3.57 ms
...
Measuring impact of model size (constant number of files = 4)...
  factor=1, totalElements=8 -> 22.36 ms
  factor=2, totalElements=16 -> 19.71 ms
  factor=4, totalElements=32 -> 19.85 ms
...
Measuring impact of model size (constant number of files = 4)...
  factor=1, totalElements=8 -> 14.75 ms
  factor=2, totalElements=16 -> 13.38 ms
  factor=4, totalElements=32 -> 13.83 ms
...
Measuring impact of model size (constant number of files = 4)...
  factor=1, totalElements=8 -> 27.31 ms
  factor=2, totalElements=16 -> 30.90 ms
  factor=4, totalElements=32 -> 15.26 ms
  factor=8, totalElements=64 -> 14.04 ms
  factor=16, totalElements=128 -> 12.11 ms
  factor=32, totalElements=256 -> 40.65 ms
  factor=64, totalElements=512 -> 130.56 ms
  factor=128, totalElements=1024 -> 91.58 ms
...
Measuring impact of model size (constant number of files = 4)...
  factor=1, totalElements=8 -> 21.60 ms
  factor=2, totalElements=16 -> 21.11 ms
  factor=4, totalElements=32 -> 21.24 ms
