 ...
 * @generated
 */
public class BooksActionBarContributor
	...
	public BooksActionBarContributor() {
		...
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(LibraryEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("books-settings"));
		toolBarManager.add(new Separator("books-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(LibraryEditorPlugin.INSTANCE.getString("_UI_BooksEditor_menu"), "booksMenuID");
